...
export const authRegisterUserSchema = Joi.object({
  ...
  [fields[1]]: Joi.string()
    ...
    // TODO error messages will be separate for each regex but overall should fullfil main common password pattern
    // TODO for example:
    // TODO const hasLetter = /(?=.*[A-Za-z])/;
    // TODO const hasDigit = /(?=.*\d)/;
    // TODO const validChars = /^[A-Za-z\d@$!%*?&]*$/;
