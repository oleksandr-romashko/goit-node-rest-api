const { UKR_NET_FROM_NAME, UKR_NET_FROM_EMAIL } = process.env;
...
export const emailConfirmationHtml = (
  confirmationLink = "#",
  isResent = false,
  supportTeamEmail = UKR_NET_FROM_EMAIL
) => `<!DOCTYPE html>
<html>
...
<body>
  <div class="email-container">
    ...
    If you have any questions, feel free to
      ${
        supportTeamEmail
          ? `<a href="mailto:${supportTeamEmail}?subject=Email verification for node-rest-api&body=Dear node-rest-api Team," aria-label="contact support">contact our support team</a>`
          : `contact our support team`
      }
      .
    </p>

    <p class="signature">Best regards,<br>${UKR_NET_FROM_NAME}</p>
